...
class ViewController: UIViewController {
    ...
    var collectionView = UICollectionView(frame: .zero, collectionViewLayout: GridCompositionalLayout.generateLayout())
    
    var model = ColorRepository()
    ...
    func prepareCollectionView() {
        ...
        NSLayoutConstraint.activate(
            [
                collectionView.topAnchor.constraint(equalTo: view.topAnchor, constant: view.frame.height / 2), // переделать
